            ...
            <div className="OpenStore-Section1open-rule">
                <div className="OpenStore-Section1container">
                    <div className="OpenStore-Section1rule-wr">
                        <div className="OpenStore-Section1rule-left t22 fw-6"><span className="rule-popup --unl cursor-pointer">THỂ LỆ - </span><span className="rule-date">Áp dụng từ ngày: 03/08 - 30/08/2024</span></div>
