    ...
    return (
        <div className="OpenStore-Section1-Container" style={{ backgroundColor: "#fcf9d6" }}>
            ...
            <div className="open-bner">
                <div className="open-bner-wr"><img alt="khai-truong" loading="lazy" width="1728" height="360" decoding="async" data-nimg="1" style={{ color: "transparent", borderRadius: "0" }} ></div>
