    ...
    return (
        <div className="OpenStore-Section1-Container" style={{ backgroundColor: "#fcf9d6" }}>
            ...
            <div className="open-bner">
                <div className="open-bner-wr">
                    <img alt="khai-truong" style={{ color: "transparent", borderRadius: "0" }} src='https://bachlongmobile.com/_next/image?url=%2Fassets%2Fimages%2Fop-bner.jpg&w=1920&q=75' />
                </div>
