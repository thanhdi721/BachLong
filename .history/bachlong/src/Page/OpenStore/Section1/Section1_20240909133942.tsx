    ...
    return (
        <div className="OpenStore-Section1-Container" style={{ backgroundColor: "#fcf9d6" }}>
            ...
            <div className="open-bner">
                <div className="open-bner-wr"><img alt="khai-truong" loading="lazy" decoding="async" data-nimg="1" style={{ color: "transparent", borderRadius: "0" }} src='https://bachlongmobile.com/_next/image?url=%2Fassets%2Fimages%2Fop-bner.jpg&w=1920&q=75' />
                </div>
                <div className="open-scroll">
                    <div className="container">
                        <div className="open-list">
                            <div className="open-item x1">
                                <a href="#deal-shock-list"><img src="https://www.bachlongmobile.com/assets/images/box-khai-truong-3.png" /></a>
                            </div>
                            <div className="open-item x2">
                                <a href="#list-mega-sale"><img src="https://www.bachlongmobile.com/assets/images/box-khai-truong-3.png" /></a>
                            </div>
                            <div className="open-item x3">
                                <a href="#trung-qua-sn18"><img src="https://www.bachlongmobile.com/assets/images/box-khai-truong-3.png" /></a>
                            </div>
                            <div className="open-item x2">
