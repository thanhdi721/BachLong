            ...
            <div className="open-rule">
                <div className="container">
                    <div className="rule-wr">
                        <div className="rule-left t22 fw-6"><span class="rule-popup --unl cursor-pointer">THỂ LỆ - </span><span className="rule-date">Áp dụng từ ngày: 03/08 - 30/08/2024</span></div>
