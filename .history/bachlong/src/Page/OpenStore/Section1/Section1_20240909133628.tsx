...
function Section1() {
    ...
    return (
        <div className="OpenStore-Section1-Container" style={{ backgroundColor: "#fcf9d6" }}>
            ...
            <div class="open-bner">
                <div class="open-bner-wr"><img alt="khai-truong" loading="lazy" width="1728" height="360" decoding="async" data-nimg="1" style="color:transparent;border-radius:0" srcset="/_next/image?url=%2Fassets%2Fimages%2Fop-bner.jpg&amp;w=1920&amp;q=75 1x, /_next/image?url=%2Fassets%2Fimages%2Fop-bner.jpg&amp;w=3840&amp;q=75 2x" src="/_next/image?url=%2Fassets%2Fimages%2Fop-bner.jpg&amp;w=3840&amp;q=75"></div>
                <div Clas="open-scroll">
                    <div class="container">
                        <div class="open-list">
                            <div class="open-item x1">
                                <a href="#deal-shock-list"><img src="/assets/images/box-khai-truong-1.png"></a>
                            </div>
                            <div class="open-item x2">
                                <a href="#list-mega-sale"><img src="/assets/images/box-khai-truong-2.png"></a>
                            </div>
                            <div class="open-item x3">
                                <a href="#trung-qua-sn18"><img src="/assets/images/box-khai-truong-3.png"></a>
                            </div>
                            <div class="open-item x2">
                                <a href="#trung-qua-sn18"><img src="/assets/images/box-khai-truong-4.png"></a>
                            </div>
                            <div class="open-item x1">
