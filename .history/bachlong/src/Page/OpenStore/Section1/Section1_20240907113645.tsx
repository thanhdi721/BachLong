...
function Section1() {
    return (
        <div className="OpenStore-Section1-Container">
            ...
            <div className="OpenStore-Section1open-rule">
                <div className="OpenStore-Section1container">
                    <div className="OpenStore-Section1rule-wr">
                        <div className="OpenStore-Section1rule-left t22 fw-6"><span className="OpenStore-Section1rule-popup --unl cursor-pointer">THỂ LỆ - </span><span className="OpenStore-Section1rule-date">Áp dụng từ ngày: 03/08 - 30/08/2024</span></div>
                        <div className="OpenStore-Section1rule-right t22 fw-6"><span className="OpenStore-Section1rule-expired">Chương trình đã kết thúc</span></div>
                    </div>
                </div>
            </div>
        </div>
