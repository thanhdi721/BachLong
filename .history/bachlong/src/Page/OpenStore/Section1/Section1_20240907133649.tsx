        ...
        <div className="OpenStore-Section1-Container" style={{ backgroundColor: "#fcf9d6" }}>
            ...
            <div >
                <div style={{ textAlign: 'center' }}>
                    ...
                    <div className='OpenStore-Section1-boxText'>
                        <p><strong>MỪNG SINH NHẬT: 100% MUA LÀ CÓ QUÀ </strong> Tất cả các khách hàng đến tham quan mua sắm trong chương trình với tổng hóa đơn từ 5.000.000 sẽ nhận được 1 phần quà sinh nhật cùng với Bạch Long Mobile: - <strong></strong> - Số lượng quà tặng có hạn, quý khách hàng hãy nhanh chân đến Bạch Long nhận quà nhé. MỪNG SINH NHẬT: MIỄN PHÍ CHUYẾN ĐI ĐẾN BẠCH LONG MUA SẮM Duy nhất và độc quyền trong sự kiện sinh nhật lần này, tất cả các khách hàng trong nội thành TP.HCM đến tham quan mua sắm tại hệ thống Bạch Long Mobile di chuyển bằng các hình thức xe công nghệ có hóa đơn thể hiện lộ trình đến cửa hàng Bạch Long Mobile gần nhất, sẽ nhận được ưu đãi: - Hoàn 100% chi phí chuyến đi cho khách hàng (tối đa 300.000Đ). - Áp dụng hoàn tiền cho khách hàng có tổng hóa đơn mua sắm từ 5.000.000 - Quý khách vui lòng cung cấp chứng từ hóa đơn di chuyển có thể hiện điểm đến là Bạch Long Mobile gần nhất để được hoàn tiền. - Mỗi khách hàng chỉ được hoàn tiền 1 lần trong suốt thời gian chương trình diễn ra.
                        </p>
                    </div>
                </div>
            </div>
