            ...
            <div >
                <div style={{ textAlign: 'center' }}>
                    ...
                    <div>
                        ...
                        <strong style={{ textAlign: "center" }}>- Hóa đơn mua MÁY từ 5.000.000</strong>
                        <strong style={{ textAlign: "center" }}>==> Nhận 1 Phiếu Hẹn tham gia vòng quay vật lý trúng thưởng Galaxy Z Flip6 256GB Chính Hãng</strong>
                        <strong style={{ textAlign: "center" }}>- Hóa đơn mua PHỤ KIỆN từ 300.000</strong>
