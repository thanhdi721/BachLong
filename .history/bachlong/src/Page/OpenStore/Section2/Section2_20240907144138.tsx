        ...
        <div className='OpenStore-Section2-Container'>
            <div className='OpenStore-Section2-Container-Product'>
                ...
                <div>
                    ...
                    <div class="swiper-slide prt-slide-item col" style="height: calc(50% + 0px); width: 297px;" data-swiper-slide-index="1"><div className="prt-box open-prt-item"><div className="prt-info-tab"><ul className="info-tab-list"><li className="info-tab-item --bd"><span className="txt t10">Trả góp 0%</span></li></ul></div><div className="prt-info-img"><a class="info-img" href=""><img src="https://beta-api.bachlongmobile.com/media/landingpagebanner/150824-FRAME-18-SAP-SAN-300.png" alt="" loading="lazy"><img alt="" loading="lazy" width="1000" height="1000" decoding="async" data-nimg="1" className="img-sale" srcset="/_next/image?url=https%3A%2F%2Fbeta-api.bachlongmobile.com%2Fmedia%2Fcatalog%2Fproduct%2Fcache%2Fbfb35fd1430014b0a164bf3a48626862%2Fm%2Fa%2Fmac-topzone-promax-black-650x650_1_1.png&amp;w=1080&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fbeta-api.bachlongmobile.com%2Fmedia%2Fcatalog%2Fproduct%2Fcache%2Fbfb35fd1430014b0a164bf3a48626862%2Fm%2Fa%2Fmac-topzone-promax-black-650x650_1_1.png&amp;w=2048&amp;q=75 2x" src="/_next/image?url=https%3A%2F%2Fbeta-api.bachlongmobile.com%2Fmedia%2Fcatalog%2Fproduct%2Fcache%2Fbfb35fd1430014b0a164bf3a48626862%2Fm%2Fa%2Fmac-topzone-promax-black-650x650_1_1.png&amp;w=2048&amp;q=75" ></a></div><div className="prt-info-dt"><div className="info-name t14 fw-7"><span className="inner-txt">Macbook Pro 2023 (M3 Pro) 14 inch 18GB/1TB - Chính hãng Apple VN</span></div><div className="info-price"><p className="price-curr t16 fw-7 ">56.390.000 VNĐ</p><p className="price-origin t14">65.990.000 VNĐ<span className="info-tab-item --bg"><span className="txt t13">-15%</span></span></p></div><a className="btn-buy-prt btn --buy !w-full" href="/products/macbook-pro-2023-m3-pro-14-inch-18gb-1tb-chinh-h-ng-apple-vn"><span className="txt t18 fw-6 --upper">Mua ngay</span></a></div></div></div>
                    </div>
                </div>
