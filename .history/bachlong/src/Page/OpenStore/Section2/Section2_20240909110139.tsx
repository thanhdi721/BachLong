...
To make the number of slides per row responsive based on the screen width, you can use media queries to dynamically adjust the slidesPerRow value in your carousel settings.

    Here's an example of how you can achieve this with the react-slick carousel:

Define your responsive settings:

Modify your carousel settings to include a responsive property.This property will hold different settings for various breakpoints.
...
const settings = {
    ...
    responsive: [
        {
            breakpoint: 1000, // Adjust for larger screens
            settings: {
                slidesPerRow: 4,
            }
        },
