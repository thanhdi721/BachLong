                ...
                {activeButton === 1 && (
                    <div style={{ display: 'flex', justifyContent: 'center', gap: "10px" }}>
                        ...
                        <p
                            ...
                            style={{
                                backgroundColor: activeButtonProduct === 2 ? '#fff200' : 'white',
                        ...
                        <p
                            ...
                            style={{
                                backgroundColor: activeButtonProduct === 3 ? '#fff200' : 'white',
                        ...
                        <p
                            ...
                            style={{
                                backgroundColor: activeButtonProduct === 4 ? '#fff200' : 'white',
                ...
                {activeButton === 3 && (
                    <div style={{ display: 'flex', justifyContent: 'center', gap: "10px" }}>
                        <p
                            onClick={() => handleButtonProductClick(1)}
                            style={{
                                backgroundColor: activeButtonProduct === 1 ? '#fff200' : 'white',
