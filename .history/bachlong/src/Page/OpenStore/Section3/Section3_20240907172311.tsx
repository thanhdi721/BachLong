            ...
            <div className='OpenStore-Section3-Container-Product'>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: "10px" }}>
                    <p
                        ...
                        style={{
                            backgroundColor: activeButton === 1 ? 'red' : 'white',
                    ...
                    <p
                        ...
                        style={{
                            backgroundColor: activeButton === 2 ? 'red' : 'white',
                    ...
                    <p
                        ...
                        style={{
                            backgroundColor: activeButton === 3 ? 'red' : 'white',
                    ...
                    <p
                        ...
                        style={{
                            backgroundColor: activeButton === 4 ? 'red' : 'white',
