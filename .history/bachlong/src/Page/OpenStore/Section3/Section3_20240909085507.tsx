        ...
        <div className='OpenStore-Section3-Container'>
            <div className='OpenStore-Section3-Container-Product'>
                ...
                {activeButtonProduct === 5 && (
                    <div style={{ width: '76vw', marginLeft: '-10px' }}>
                        <div className="grid-container">
                            {totalItemsToDisplay.map((data, index) => (
                            ...
                            {/* Render placeholder items if needed to complete a row */}
                            {Array.from({ length: fakeData1 }).map((_, index) => (
                                <div key={`placeholder-${index}`} className="grid-item placeholder"></div>
                            ))}
                        </div>
                        {/* See More Button */}
